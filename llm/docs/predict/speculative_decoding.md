...
5.【**推荐**】一键容器启动 Base Model 静态图 + MTP 动态图
...
# 第二个节点
ping 192.168.0.2
model_name=${model_name:-"deepseek-ai/DeepSeek-R1-2nodes/weight_only_int8"} 详见附录静态图modelname表格
POD_0_IP 表示master节点ip
export POD_IPS=master节点，slave节点，该环境变量在2机上都需保持一致
